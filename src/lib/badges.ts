...
export const BADGES: BadgeMeta[] = [
  ...
  { id: "point_100", name: "별빛 부자", emoji: "💯", description: "별빛 100 달성", category: "fun" },
  { id: "point_500", name: "별빛 왕", emoji: "👑", description: "별빛 500 달성", category: "fun" },
  ...
  { id: "point_1000", name: "다이아", emoji: "💎", description: "별빛 1000 달성", category: "fun" },
