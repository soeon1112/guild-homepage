...
const FOX: Record<Exclude<PetStage, "egg">, PixelGrid> = {
  ...
  adult: [
    ...
    "..31pp11111111111111111111111pp3",
...
const HAMSTER: Record<Exclude<PetStage, "egg">, PixelGrid> = {
  ...
  adult: [
    ...
    "....3BwBBBwB1111111BwBBBwB1113..",
    "....31wBwBw111111111wBwBw11113..",
    "....31wwwww111111111wwwww113....",
    "....31pp111111111111111111pp13..",
    "....31111111111p1111111111113...",
...
const PANDA: Record<Exclude<PetStage, "egg">, PixelGrid> = {
  ...
  adult: [
    ...
    "....3111111111111111111111111113",
    "....3BB111111111111111111BB113..",
    "....3BwwwwwB1111111BwwwwwB1113..",
    "....3BwBBBwB1111111BwBBBwB1113..",
    "....3BwBwBwB1111111BwBwBwB1113..",
    "....3BwwwwwB1111111BwwwwwB13....",
    "....3Bpp1111111111111111ppB113..",
    "....311111111BBBBB111111111113..",
    "....3111111111BBB111111111111113",
    "....3111111111B1B111111111111113",
...
// Sleep overlay — same eye region as blink but with a black "─" dash
// across the middle so the closed eyes read as ─ ─ instead of just
// blanking out. Painted while activeScene === "sleep" for any non-egg
// stage. Egg has no eyes so the overlay is gated upstream.
export const SLEEP_OVERLAY: PixelGrid = [
  "................",
  "................",
  "................",
  "................",
...
export const ADULT_SLEEP_OVERLAY: PixelGrid = [
  "................................",
  "................................",
  "................................",
  "................................",
...
export function sleepOverlayFor(grid: PixelGrid): PixelGrid {
  return spriteCols(grid) >= 32 ? ADULT_SLEEP_OVERLAY : SLEEP_OVERLAY;
}
