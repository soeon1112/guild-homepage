  ...
  return (
    ...
    >
      ...
      <span
        className={
          dawnlight2
            ? "max-w-full truncate text-[9px] font-semibold tracking-wide"
            : "max-w-full truncate font-serif text-[9px] tracking-wide text-text-sub/80"
        }
        style={
          dawnlight2
            ? {
                color: isEarned ? "#fef5e6" : "rgba(254,245,230,0.4)",
                opacity: 1,
              }
      ...
      {mounted &&
        ...
        createPortal(
          dawnlight2 ? (
            <div
              className="dl2-minihome pointer-events-none fixed z-[100] whitespace-nowrap rounded-md px-2.5 py-1.5 text-center"
              style={{
                top: tipPos.top,
                left: tipPos.left,
            ...
            >
              ...
              <span
                ...
                className={
                  ...
                  (tipPos.below ? "top-0 -translate-y-1/2" : "top-full -translate-y-1/2")
                }
                style={{
                  background: "#fef5e6",
                  borderTop: tipPos.below
                    ? "1px solid rgba(92, 58, 31, 0.2)"
                    : "none",
                  borderLeft: tipPos.below
                    ? "1px solid rgba(92, 58, 31, 0.2)"
                    : "none",
                  borderBottom: tipPos.below
                    ? "none"
                    : "1px solid rgba(92, 58, 31, 0.2)",
                  borderRight: tipPos.below
                    ? "none"
                    : "1px solid rgba(92, 58, 31, 0.2)",
                }}
              />
      ...
      {dawnlight2 ? (
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p
              className="wrap-anywhere text-[13px] italic"
              style={{ color: "#8a6a4a" }}
            >
              {desc}
            </p>
    ...
    >
      {dawnlight2 ? (
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            <span className="text-3xl" aria-hidden style={{ color: "#c87838" }}>
              ✦
            </span>
            <h3
            ...
            <p
              className="break-keep text-[12px] italic leading-relaxed"
              style={{ color: "#8a6a4a" }}
            >
              이 별빛은 본인에게만 보입니다
            </p>
